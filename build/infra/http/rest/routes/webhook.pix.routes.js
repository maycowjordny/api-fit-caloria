...
var webhook_pix_routes_exports = {};
__export(webhook_pix_routes_exports, {
  webhookPixRoutes: () => webhookPixRoutes
});
module.exports = __toCommonJS(webhook_pix_routes_exports);
...
async function webhookPixRoutes(app) {
