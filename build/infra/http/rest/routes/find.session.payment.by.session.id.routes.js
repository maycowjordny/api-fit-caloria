...
var find_session_payment_by_session_id_routes_exports = {};
__export(find_session_payment_by_session_id_routes_exports, {
  findPaymentSessionBySessionId: () => findPaymentSessionBySessionId
});
module.exports = __toCommonJS(find_session_payment_by_session_id_routes_exports);
...
async function findPaymentSessionBySessionId(app) {
  app.post("/", findPaymentSessionBySessionIdController.find);
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  findPaymentSessionBySessionId
});
